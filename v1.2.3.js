      ...
      if ((differentCoordCounts === 0) | isFinalCluster) {
        ...
        featuresObject.forEach((element, index) => {
          popUp.insertAdjacentHTML(
            "afterend",
            `<a href="${google}" style="display:flex; border: 1px solid #f0f0f0; justify-content: space-between;" class="popup-wrapper"><h4>${element.properties.title}</h4> <img loading="lazy" class="popup_img" alt src="${element.properties.imgURL}" ></a>`
          );
        });
      } else {
